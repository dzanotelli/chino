...
func TestDocumentCRUDL(t *testing.T) {
    ...
    schema := Schema{
        ...
        Structure: []SchemaField{
            {Name: "integerField", Type: TypeInteger},
            {Name: "flaotField", Type: TypeFloat},
            {Name: "stringField", Type: TypeString},
            {Name: "textField", Type: TypeText},
            {Name: "boolField", Type: TypeBoolean},
            {Name: "dateField", Type: TypeDate},
            {Name: "timeField", Type: TypeTime},
            {Name: "datetimeField", Type: TypeDateTime},
            {Name: "base64Field", Type: TypeBase64},
            {Name: "jsonField", Type: TypeJson},
            {Name: "blobField", Type: TypeBlob},
            {Name: "arrayIntegerField", Type: TypeArrayInteger},
            {Name: "arrayFloatField", Type: TypeArrayFloat},
            {Name: "arrayStringField", Type: TypeArrayString},
        },
    }
    ...
    if err != nil {
        ...
        var tests = []struct {
            ...
            {dummyUUID.String(), doc.Content["blobField"].(uuid.UUID).String()},
